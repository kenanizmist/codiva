...
conn.Open "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" & Server.MapPath("/db/harc.mdb")
        ...
        cmd.CommandText = sql
        cmd.CommandType = 2 ' adCmdText

        ' Parametreyi ekle
        cmd.Parameters.Append cmd.CreateParameter("sifre", 200, 2, 255, userPassword)
        ...
        If Not rs.EOF Then
            ...
            Response.Redirect "../harcirah_liste.asp"
        Else
            ' Hatalı şifre
            hasError = True
...
<table class="message-container">
	<tr>
		<td>
			<div class="message-container">
				...
				<% End If %>
				<form action="magaza_giris2.asp" method="post" onsubmit="return validatePassword()">
	...
	<tr>
		<td>		
			<button onclick="window.location.href='../index.html'" class="btn"><b>Geri</button>				
		</td>
	</tr>
</table>
</body>
