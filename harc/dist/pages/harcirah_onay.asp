    ...
    If Not rs.EOF Then
     Do While Not rs.EOF
      ...
      <tr class="<%=rowClass%>">
       <td class="tdw">
        <% 
            Dim resimAdi, resimYolu
            resimAdi = rs("resim") ' Veritabanındaki "resim" sütununun adını doğru şekilde ayarlayın
            resimYolu = "savefiles/" & resimAdi

            ' Eğer resim adı boş değilse resmi göster
            If resimAdi <> "" Then
        %>
            <a href="#" onclick="showImage('<%=resimYolu%>'); return false;">
                <img src="<%=resimYolu%>" width="50" height="50">
            </a>
        <% Else %>
            Resim Yok
        <% End If %>
