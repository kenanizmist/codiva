            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img
                  ...
                  alt="User Image"
                />
                <span class="d-none d-md-inline">Muhasebe</span>
              </a>
            </li>
				...
				<tr>
					<td colspan="16" align="center">
						<form class="form-inline my-2 my-lg-0" onsubmit="event.preventDefault(); filtrele();">
							...
							<button class="btn btn-outline-success my-4 my-sm-0" type="button" onclick="window.location.href='harcirah_liste2.asp'">Temizle</button>
